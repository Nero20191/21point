    ...
    updateState() {
        ...
        switch (this.actor.state) {
            case ActorPlayingState.Normal:
                this.cardInfo.active = true;
                this.spCardInfo.spriteFrame = game.assetMng.getComponent('AssetMng').texCardInfo;
                this.updatePoint();
                break;
            case ActorPlayingState.Bust:
                let min = Utils.getMinMaxPoint(this.actor.cards).min;
                this.labelCardInfo.string = '爆牌(' + min + ')';
                this.spCardInfo.spriteFrame =game.assetMng.getComponent('AssetMng').assetMng.texBust;
                this.cardInfo.active = true;
                let animFX = this.animFX.getComponent('FXPlayer');
                animFX.show(true);
            ...
            case ActorPlayingState.Stand:
                ...
                this.spCardInfo.spriteFrame = game.assetMng.getComponent('AssetMng').assetMng.texCardInfo;
                this.resetCountdown();
                // this.updatePoint();
                break;
        }
